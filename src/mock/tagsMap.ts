...
const categoryTagsMap = {
  ...
  运维: {
    tags: ['docker', '容器', '运维', 'devops', 'kubernetes'],
  },
  测试: {
    tags: [
      'postman',
  ...
  网络: {
    tags: ['网络协议', '网络安全', 'http', 'p2p', 'tcp', 'udp'],
  },
  嵌入式: {
    tags: [
      'arm',
  ...
  区块链: {
    tags: ['虚拟货币', '以太坊', '区块链', '比特币', '智能合约', '信任链'],
  },
  软件工程: {
    tags: ['敏捷开发', '接口文档'],
  },
...
Object.keys(categoryTagsMap).forEach((parentTag) => {
  categoryTagsMap[parentTag as keyof typeof categoryTagsMap].tags.forEach(
    (tag: string) => {
      allTagsSet.add(tag);
    },
  );
